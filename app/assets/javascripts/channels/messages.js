...
App.messages = App.cable.subscriptions.create('MessagesChannel', {
   connected: function (data) {
    ...
    received: function (data) {
      ...
      var content = "<div class='message-container'><div class='avatar-wrapper'><img class='message-avatar' src='http://placehold.it/100/100'><p>" + data.user + "</p></div><div class='message-text-balloon'>" + data.message + "</div></div>"
